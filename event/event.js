    ...
    */
    ...
    touchMove: function(e) {
        ...
        if (Math.abs(this.touch.xl - this.touch.x2) > 10) {
            //阻止页面滚动
            //兼容谷歌滚动优化，阻止前，首先检测能否阻止//可以阻止，并且尚未阻止
    ...
    getDestence: function() {
        ...
        return Math.round(Math.sqrt(Math.pow(touch.x2 - touch.x1, 2) + Math.pow(touch.y2 - touch.yl, 2)));
    },

    getTouchEvent: function(isEnd) {
        //获取x坐标
        var x = isEnd ? this.touch.x2 : this.touch.xl;
        //获取y坐标
        var y = isEnd ? this.touch.y2 : this.touch.yl;
        //返回事件对象
        return {
            //时间戳
            timeStamp: Date.now(),
    ...
    touchCancel: function() {
        this,
        tapTimeout && clearTimeout(this.tapTimeout);
        //取消轻拍事件
    ...
    keyDown: function(e) {
        ...
        switch (e.keyCode) {
            ...
            case 38:
                ...
                //右
            case 39:
                this.aendkeyboardMsg('right', 180, e.keyCode)
                break;
                //下
            case 40:
