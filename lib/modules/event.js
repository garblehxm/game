IView('Event', {
    ...
    beforeCreate: function(instance) {
        instance.message = this.EVENT_NESSAGE;
    },
    initialize: function() {
        //事件对象，用于存储事件信息
        this.touch = {};
    ...
    */
    ...
    swipe: function() {
        ...
        this.swipeTimeout = setTimeout(function() {
            ...
            console.log(data)
                //触发滑动事件，并传递滑动角度
            this.trigger('IView.event.swipe', data.angle, this.touch, data.dir)
                //触发具有方向的滑动事件
    ...
    sendkeyboardMsg: function(dir, angle, keyCode) {
        ...
        //模拟滑动事件
        this.trigger('IView.event.swipe' + dir[0].toUpperCase() + dir.slice(1), angle, this.touch, dir);
        //模拟键盘事件
